...
import {
  ...
  Dimensions, TouchableWithoutFeedback, BackHandler,
} from 'react-native';
...
function Spinner() {
  ...
  return (
    <Animated.View style={[{
      ...
      borderRadius: moderateScale(26), borderWidth: 4,
      borderColor: COLORS.primaryPale, borderTopColor: COLORS.primary,
...
function AlertBtn({ btn, onDismiss, isLast }) {
  ...
  return (
    <TouchableOpacity onPress={handlePress} onPressIn={onIn} onPressOut={onOut} activeOpacity={1} style={{ flex: 1 }}>
      <Animated.View style={[{
        height: moderateScale(46), borderRadius: SIZES.radius.lg,
        alignItems: 'center', justifyContent: 'center',
        paddingHorizontal: SIZES.padding.md, backgroundColor: bgColor,
        transform: [{ scale: scaleAnim }],
      }, hasBorder && { borderWidth: 1.5, borderColor }, !isLast && { marginRight: SIZES.margin.sm }]}>
...
export default function CustomAlert({
  visible, type = 'info', title, message, iconName,
  buttons = [{ label: 'OK', style: 'primary' }],
  dismissible = true, onDismiss, loading = false, autoDismiss = 0,
}) {
  ...
  const typeConfig = {
    success: { icon: 'checkmark-circle', iconColor: COLORS.success,   iconBg: 'rgba(123,174,58,0.12)',  ringColor: 'rgba(123,174,58,0.25)',  accentBar: COLORS.success },
    error:   { icon: 'close-circle',     iconColor: COLORS.error,     iconBg: 'rgba(220,38,38,0.1)',    ringColor: 'rgba(220,38,38,0.2)',    accentBar: COLORS.error },
    warning: { icon: 'warning',          iconColor: COLORS.warning,   iconBg: COLORS.orangeOpacity10,  ringColor: COLORS.orangeOpacity30,   accentBar: COLORS.warning },
    info:    { icon: 'information-circle', iconColor: COLORS.info,    iconBg: 'rgba(59,130,246,0.1)',   ringColor: 'rgba(59,130,246,0.2)',   accentBar: COLORS.info },
    gold:    { icon: 'star',             iconColor: COLORS.secondary, iconBg: COLORS.goldOpacity10,    ringColor: COLORS.goldOpacity30,     accentBar: COLORS.secondary },
    confirm: { icon: 'help-circle',      iconColor: COLORS.primary,   iconBg: COLORS.orangeOpacity10,  ringColor: COLORS.orangeOpacity20,   accentBar: COLORS.primary },
  };
    ...
    <View style={StyleSheet.absoluteFill} pointerEvents="box-none">
      ...
      <View style={{ ...StyleSheet.absoluteFillObject, alignItems: 'center', justifyContent: 'center', zIndex: 51 }} pointerEvents="box-none">
        <Animated.View style={[{
          ...
          borderRadius: SIZES.radius.xxl, alignItems: 'center',
          paddingHorizontal: SIZES.padding.xxl, paddingTop: SIZES.padding.lg,
          paddingBottom: SIZES.padding.xl, overflow: 'hidden',
          ...SHADOWS.xl, opacity: cardOp,
