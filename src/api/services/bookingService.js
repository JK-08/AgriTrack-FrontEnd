...
export const bookingService = {
  ...
  byDriver: (driverId)    => callApi({ method: 'get',  url: BOOKING.BY_DRIVER(driverId) }),
  pending:  (ownerId)     => callApi({ method: 'get',  url: BOOKING.PENDING(ownerId) }),
  getById:  (id)          => callApi({ method: 'get',  url: BOOKING.GET_BY_ID(id) }),
  assignDriver: (id, driverId, tractorId) => callApi({ method: 'put', url: BOOKING.ASSIGN_DRIVER(id), params: tractorId ? { driverId, tractorId } : { driverId } }),
